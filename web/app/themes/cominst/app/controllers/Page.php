 ...
 */
 public function mainNavItems() {
    ...
    $menu_items = array_filter($menu_items, function($item) { return $item->menu_item_parent == 0; });
    usort($menu_items, function($item_a, $item_b) { return $item_a->menu_order > $item_b->menu_order ? 1 : -1; });
    return $menu_items;
 }
